...
map_gtfs <- function(gtfs_obj, agency_name = NULL, route_ids = NULL, service_ids = NULL, include_stops = TRUE, only_stops = FALSE, stop_opacity = 0.5, route_opacity = NULL, route_colors = NULL) {
