...
test_that('Check if/how we are parsing files', {
	...
	expect_null(gtfsr:::parse_gtfs('_empty', empty_file)) # expect null since file is empty
	expect_is(gtfsr:::parse_gtfs('agency', agency_file), 'tbl_df') # check for tibble object
