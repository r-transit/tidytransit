...
3) Estimate Headways at Stops
4) Map headways along multiple lines 
5) Map total departures along all routes and lines in the NYC Subway.
...
# 3) Headways Between 6 am and 10 am on stops on the 1 Train. 
...
The `get_stop_frequency` function simply counts the number of departures within the time frame to get departures per stop. Then, to get headways, it divides the number of departures by the number of minutes by the number of departures, and rounds to the nearest integer. 
...
# 4) Headways Between 6 am and 10 am on stops for all Routes
...
# 5) Map Departures Between 6 am and 10 am for all Stops and for All Routes
