...
- Coerce [stops and routes to 'simple features'](http://tidytransit.r-transit.org/reference/get_stop_geometry.html) and [plot them](http://tidytransit.r-transit.org/reference/plot.gtfs.html)
...
- [Estimate travel time between transit stops](http://tidytransit.r-transit.org/reference/raptor.html)
