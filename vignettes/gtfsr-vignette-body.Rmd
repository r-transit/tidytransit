...
From inspecting the output from `attr(df, 'problems')` and comparing it to `df`, it appears the problems for this particular `calendar_df` stem from the empty rows added to the end of the original text file. Not a big deal and easily fixed but we leave such specific fixes to the user to correct.
