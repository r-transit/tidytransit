...
Next, let's map out all the stops and shape for the popular bus route *C1 East-West Loop*. We first find the route before mapping all the stops using `map_gtfs_route_stops()` and the shape using `map_gtfs_route_shape()`.
...
map_gtfs_route_stops(gtfs_obj = duke_gtfs_obj, route_id = C1_route_id)

map_gtfs_route_shape(gtfs_obj = duke_gtfs_obj, route_id = C1_route_id)
```
