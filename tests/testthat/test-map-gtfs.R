...
test_that('Mapping single stops and routes', {
	...
	expect_is(map_gtfs_route_stops(gtfs_obj, yes_route_id), 'leaflet')
	expect_error(map_gtfs_route_stops(gtfs_obj, not_route_id1))
	expect_error(map_gtfs_route_stops(gtfs_obj, not_route_id2))
	expect_error(map_gtfs_route_stops(not_gtfs_obj, not_route_id1))
	expect_error(map_gtfs_route_stops(not_gtfs_obj, not_route_id2))
...
test_that('Mapping one or more routes or full network', {
	...
	# map_gtfs_route_shapes()
	expect_is(map_gtfs_route_shapes(gtfs_obj, yes_route_id), 'leaflet')
	expect_is(map_gtfs_route_shapes(gtfs_obj, yes_route_ids), 'leaflet')
	expect_is(map_gtfs_route_shapes(gtfs_obj, yes_route_ids, yes_service_ids), 'leaflet')
	expect_warning(map_gtfs_route_shapes(gtfs_obj, ok_route_ids))
	expect_warning(map_gtfs_route_shapes(gtfs_obj, yes_route_ids, ok_service_ids))
	expect_error(map_gtfs_route_shapes(gtfs_obj, yes_route_ids, no_service_ids))
	expect_error(map_gtfs_route_shapes(gtfs_obj, not_route_id1))
	expect_error(map_gtfs_route_shapes(gtfs_obj, not_route_id2))
	expect_error(map_gtfs_route_shapes(not_gtfs_obj, not_route_id1))
	expect_error(map_gtfs_route_shapes(not_gtfs_obj, not_route_id2))
