...
Looking at the first two departures we see that a train departures at 00:04 and looking at 
the `service_id` and `trip_id` we can guess that this happens saturdays and weekdays.  
