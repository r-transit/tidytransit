...
In addition, `gtfs$.$date_servicepattern_table` has been created which connects dates and service patterns (like `date_service_table`). We can compare the number of service patterns to the number of services.
