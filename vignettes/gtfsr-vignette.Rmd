...
To understand the problem, let's extract the data frame `calendar_df`. Recall that `get_gtfs` returns a list where each element of the list is a set of data frames.
