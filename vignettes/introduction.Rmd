...
- Coerce [stops and routes to 'simple features'](http://tidytransit.r-transit.org/reference/get_stops_geometry.html) and [plot them](http://tidytransit.r-transit.org/reference/plot.gtfs.html)
