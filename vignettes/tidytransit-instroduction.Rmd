---
title: "tidytransit-introduction"
date: "`r Sys.Date()`"
...
When you call `import_gtfs`, tidytransit attempts to append a `simple features` data frame for stops and routes to the list of gtfs dataframes. 
...
![gtfs-relationship-diagram](figures/dependency-graph.png)
