...
`readgtfs` is a package for reading the GTFS data standard into R. It can read directly from URL's or flat files, and does some validation of the data structure against the specification.  
